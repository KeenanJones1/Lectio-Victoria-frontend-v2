  ...
  return (
   ...
   <form action="">
    ...
    <div className="form-group">
     ...
     <input name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" onChange={(event) => {this.handleUserChange(event)}}/>
    </div>
